...
BOOK_INDEX = {
    ...
    {'france', 'realm', '1444', 'France', {PROVINCES.paris, PROVINCES.champagne, PROVINCES.orleans, PROVINCES.berry, PROVINCES.bourbon, PROVINCES.limousin, PROVINCES.lyon, PROVINCES.montpellier, PROVINCES.toulouse, PROVINCES.armagnac, PROVINCES.saintonge, PROVINCES.poitou, }},
    {'france', 'realm', '1618', 'France', {PROVINCES.paris, PROVINCES.champagne, PROVINCES.picardie, PROVINCES.orleans, PROVINCES.berry, PROVINCES.bourbon, PROVINCES.limousin, PROVINCES.lyon, PROVINCES.bourgogne, PROVINCES.provence, PROVINCES.montpellier, PROVINCES.toulouse, PROVINCES.bordeaux, PROVINCES.armagnac, PROVINCES.saintonge, PROVINCES.poitou, PROVINCES.nantes, PROVINCES.maine, PROVINCES.rennes, PROVINCES.normandie, PROVINCES.caux, }},
