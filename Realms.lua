...
SETUP_DATA = {
  ...
  [REALM.castile] = {
    ...
    ['1618'] = {
      ...
      l_towns = { WesternMap.madrid, WesternMap.salamanca, WesternMap.sevilla, AmericaMap.mexico,
      ...
      s_towns = { WesternMap.murcia, WesternMap.burgos, WesternMap.cordoba, WesternMap.granada, WesternMap.gibraltar, WesternMap.canarias,
                  WesternMap.badajoz, WesternMap.galicia, AmericaMap.florida, AmericaMap.antilles, AmericaMap.newgranada, AmericaMap.quito,
                  AmericaMap.charcas, AmericaMap.chile, AmericaMap.laplata, FarEastMap.philippines },
    ...
    ['S204'] = {
      ...
      l_towns = { WesternMap.madrid, WesternMap.salamanca, WesternMap.sevilla, WesternMap.valencia, AmericaMap.mexico,
                  AmericaMap.centralamerica, AmericaMap.cuzco },
      s_towns = { WesternMap.murcia, WesternMap.burgos, WesternMap.cordoba, WesternMap.badajoz, WesternMap.galicia,
                  WesternMap.navarra, WesternMap.zaragoza, WesternMap.barcelona, WesternMap.baleares,
  ...
  [REALM.france] = {
    ['1444'] = {
      ...
      l_towns = { WesternMap.paris, WesternMap.champange, WesternMap.orleans, WesternMap.lyon },
    ...
    ['1618'] = {
      ...
      l_towns = { WesternMap.paris, WesternMap.nantes, WesternMap.champange, WesternMap.bourgogne, WesternMap.lyon,
    ...
    ['S103'] = {
      ...
      l_towns = { WesternMap.paris, WesternMap.champange, WesternMap.orleans, WesternMap.bourgogne,
    ...
    ['S204'] = {
      ...
      l_towns = { WesternMap.paris, WesternMap.nantes, WesternMap.champange, WesternMap.bourgogne,
    ...
    ['S205'] = {
      parent = {REALM.france, '1444'},
      ruler = {deck_guid = Event_Deck_GUIDs.age1r, card_guid = '57c370', flip = false, ill = false },
      l_towns = { WesternMap.bordeaux, WesternMap.orleans, WesternMap.paris, WesternMap.champange,
  ...
  [REALM.mamluks] = {
    ...
    ['1618'] = {
      ...
      vassals = { WesternMap.tripoli, WesternMap.tunis, WesternMap.sousse, WesternMap.bizerte, WesternMap.qafsah, WesternMap.qusantinah,
                  EasternMap.qahirah, WesternMap.mitidja, IndiaMap.basra, IndiaMap.hejaz },
      allies = { EasternMap.constantinople },
      claims = { {-3.17, -10.30} },
      influence = { {0.15, -10.66}, {-2.20, -10.08}, {1.77, -12.10} },
      merchants = { {12.03, -10.25}, {17.12, -10.27} },
      figurines = { {12.43, -11.92}, 'none', 'none', {7.24, -8.97} },
